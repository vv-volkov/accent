Ext.define('objectEditor.controller.objectEditorController',{
    extend:'Ext.app.Controller',
    models:['objectEditorNavigModel'],
    stores:['objectEditorNavigStore'],
    views:['objectEditorNavigTree'],
    init:function(){
        this.control({
            'objectEditornavigtree':{
            ...
            'objectEditornavigtree button[itemId=refresh]':{
                click:this.refresh 
            }
        })
    },
