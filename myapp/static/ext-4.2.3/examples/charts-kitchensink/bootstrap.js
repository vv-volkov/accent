...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.chart.theme.CustomCharts": "app/view/charts/other/CustomTheme.js",
...
Ext.ClassManager.addNameAlternateMappings({
  "ChartsKitchenSink.controller.Main": [],
  "ChartsKitchenSink.view.CodePreview": [],
  "ChartsKitchenSink.view.ContentPanel": [],
  "ChartsKitchenSink.view.DescriptionPanel": [],
  "ChartsKitchenSink.view.Header": [],
  "ChartsKitchenSink.view.Navigation": [],
  "ChartsKitchenSink.view.Viewport": [],
  "ChartsKitchenSink.view.charts.area.100Stacked": [],
  "ChartsKitchenSink.view.charts.area.3D": [],
  "ChartsKitchenSink.view.charts.area.Basic": [],
  "ChartsKitchenSink.view.charts.area.Stacked": [],
  "ChartsKitchenSink.view.charts.bar.100Stacked": [],
  "ChartsKitchenSink.view.charts.bar.3D": [],
  "ChartsKitchenSink.view.charts.bar.Basic": [],
  "ChartsKitchenSink.view.charts.bar.Clustered": [],
  "ChartsKitchenSink.view.charts.bar.Stacked": [],
  "ChartsKitchenSink.view.charts.bubble.3D": [],
  "ChartsKitchenSink.view.charts.bubble.Basic": [],
  "ChartsKitchenSink.view.charts.column.100Stacked": [],
  "ChartsKitchenSink.view.charts.column.3D": [],
  "ChartsKitchenSink.view.charts.column.Basic": [],
  "ChartsKitchenSink.view.charts.column.Clustered": [],
  "ChartsKitchenSink.view.charts.column.Stacked": [],
  "ChartsKitchenSink.view.charts.combination.Dashboard": [],
  "ChartsKitchenSink.view.charts.combination.LiveDashboard": [],
  "ChartsKitchenSink.view.charts.combination.Pareto": [],
  "ChartsKitchenSink.view.charts.donut.Basic": [],
  "ChartsKitchenSink.view.charts.donut.Exploded": [],
  "ChartsKitchenSink.view.charts.gauge.Basic": [],
  "ChartsKitchenSink.view.charts.line.Basic": [],
  "ChartsKitchenSink.view.charts.line.Marked": [],
  "ChartsKitchenSink.view.charts.line.MarkedSpline": [],
  "ChartsKitchenSink.view.charts.line.Spline": [],
  "ChartsKitchenSink.view.charts.line.Stacked": [],
  "ChartsKitchenSink.view.charts.other.Animated": [],
  "ChartsKitchenSink.view.charts.other.CustomTheme": [],
  "ChartsKitchenSink.view.charts.other.LiveUpdates": [],
  "ChartsKitchenSink.view.charts.other.Reload": [],
  "ChartsKitchenSink.view.charts.other.TipCharts": [],
  "ChartsKitchenSink.view.charts.pie.3DExploded": [],
  "ChartsKitchenSink.view.charts.pie.Basic": [],
  "ChartsKitchenSink.view.charts.pie.Custom": [],
  "ChartsKitchenSink.view.charts.pie.Exploded": [],
  "ChartsKitchenSink.view.charts.radial.Basic": [],
  "ChartsKitchenSink.view.charts.radial.Filled": [],
  "ChartsKitchenSink.view.charts.radial.Marked": [],
  "ChartsKitchenSink.view.charts.scatter.Basic": [],
  "ChartsKitchenSink.view.charts.scatter.SmoothLined": [],
  "ChartsKitchenSink.view.charts.scatter.StraightLined": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "ChartsKitchenSink.view.charts.other.Animated": [
    "widget.animated-chart"
  ],
  "ChartsKitchenSink.view.charts.other.CustomTheme": [
    "widget.theme-chart"
  ],
  "ChartsKitchenSink.view.charts.other.LiveUpdates": [
    "widget.live-update-chart"
  ],
  "ChartsKitchenSink.view.charts.other.Reload": [
    "widget.reload-chart"
  ],
  ...
  "ChartsKitchenSink.view.charts.radial.Filled": [
    "widget.filled-radial"
  ],
  "ChartsKitchenSink.view.charts.radial.Marked": [
    "widget.marked-radial"
  ],
  "ChartsKitchenSink.view.charts.scatter.Basic": [
    "widget.basic-scatter"
  ],
  "ChartsKitchenSink.view.charts.scatter.SmoothLined": [
    "widget.smooth-lined-scatter"
  ],
  "ChartsKitchenSink.view.charts.scatter.StraightLined": [
    "widget.straight-lined-scatter"
  ],
  "Ext.AbstractComponent": [],
  "Ext.AbstractManager": [],
  "Ext.AbstractPlugin": [],
