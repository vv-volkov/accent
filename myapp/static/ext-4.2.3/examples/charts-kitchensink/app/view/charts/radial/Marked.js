Ext.define('ChartsKitchenSink.view.charts.radial.Marked', {
    extend: 'Ext.Panel',
    xtype: 'marked-radial',
    ...
    exampleDescription: [
        'Marked radial is a multi-series radial chart displaying trends across multiple categories. Markers are placed at each point to clearly depict their position. '
    ],
        ...
        me.items = [{
            ...
            series: [{
                ...
                tips: {
                    ...
                    height: 20,
                    renderer: function(storeItem, item) {
                        this.setTitle(storeItem.get('month') + ': ' + storeItem.get('data3') + '%');
                    }
                }
            }, {
                type: 'radar',
                ...
                tips: {
                    ...
                    height: 20,
                    renderer: function(storeItem, item) {
                        this.setTitle(storeItem.get('month') + ': ' + storeItem.get('data4') + '%');
                    }
                }
            }]
        //<example>
