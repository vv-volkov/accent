Ext.define('ChartsKitchenSink.view.charts.area.Basic', {
    extend: 'Ext.Panel',
    xtype: 'basic-area',
    ...
    exampleDescription: [
        'A basic area chart is similar to the line chart, except the area between axis and line is filled with colors to emphasize quantity.'
    ],
