Ext.define('ChartsKitchenSink.view.charts.bar.Clustered', {
    extend: 'Ext.Panel',
    xtype: 'clustered-bar',
    ...
    exampleDescription: [
        'Clustered bars are multi-series bar charts used to compare two or more categories of data. Categories are typically represented using different colors.'
    ],
