Ext.define('ChartsKitchenSink.view.charts.column.Clustered', {
    extend: 'Ext.Panel',
    ...
    exampleDescription: [
        'Clustered columns are multi-series column charts used to compare two or more categories of data. Categories are typically represented using different colors.'
    ],
