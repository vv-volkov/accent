Ext.define('ChartsKitchenSink.view.charts.column.100Stacked', {
    extend: 'Ext.Panel',
    xtype: '100-stacked-column',
    ...
    exampleDescription: [
        '100% stacked columns are multi-series column charts where categories are stacked (percentage values) on top of each other, with an additional category \'Others\' that is used to sum up the various categories for each series to a perfect 100%.'
    ],
